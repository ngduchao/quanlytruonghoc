...
public class SubjectController {
	...
	public ResponseEntity<?> getAllSubjects (
	    ...
	    if (!pageable.getSort().isSorted()) {
	        pageable = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(), Sort.by("subjectName").ascending());
	    }
    ...
    public void exportToExcel(
			...
			@RequestParam(value = "search", required = false) String search,
			SubjectFilterForm filter) throws IOException {
		
		service.exportListSubject(servletResponse, search, filter);
	}
}
