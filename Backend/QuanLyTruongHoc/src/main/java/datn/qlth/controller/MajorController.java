...
public class MajorController {
	...
	public ResponseEntity<?> getAllMajors (
		...
		if (!pageable.getSort().isSorted()) {
	        pageable = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(), Sort.by("majorName").ascending());
	    }
	...
	@GetMapping("get-list")
	public ResponseEntity<?> getListMajorNotPage(){
		List<Major> list = service.getListMajorsNotPage();
    ...
    public void exportToExcel(
		...
		service.exportListMajor(servletResponse, search, filter);
	}
}
