...
public class FacultyController {
	...
	public ResponseEntity<?> GetAllFaculties (
		...
		if (!pageable.getSort().isSorted()) {
	        pageable = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(), Sort.by("facultyName").ascending());
	    }
    ...
    public void exportToExcel(
		...
		service.exportListFaculties(servletResponse, search, filter);
	}
}
