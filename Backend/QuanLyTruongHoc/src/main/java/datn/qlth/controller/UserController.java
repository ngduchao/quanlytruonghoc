...
import datn.qlth.dto.UserUploadImageDTO;
...
public class UserController {
	...
	public ResponseEntity<?> updateProfile(Authentication authentication, UpdateProfileDTO form){
		
		User userInfo = service.getUserByUsername(authentication.getName());
		
		service.updateProfile(userInfo.getUserID(), form);
		
		User user = service.getUserByID(userInfo.getUserID());
    ...
    public void exportToExcel(
		...
		service.exportListUser(servletResponse, search, filter);
	}
	
	@PutMapping("/upload/{id}")
	public ResponseEntity<?> UserUploadImage(@PathVariable(name = "id") Integer userID, @RequestBody UserUploadImageDTO form){
		
		service.updateImage(userID, form);
