...
VALUES					('FL6085.1', 'Tiếng Anh Công nghệ thông tin cơ bản 1', 5, 1, 1, 70, 5),
						('PE6021', 'Bóng rổ', 1, 1, 2, 70, 1),
                        ('PE6026', 'Cầu lông', 1, 1, 2, 70, 1),
                        ('LP6012', 'Chủ nghĩa xã hội khoa học', 3, 1, 2, 70, 1),
                        ('LP6013', 'Lịch sử Đảng Cộng sản Việt Nam', 3, 1, 3, 70, 1),
                        ('LP6010', 'Triết học Mác-Lênin', 3, 1, 3, 70, 1),
                        ('BS6002', 'Giải tích', 3, 1, 4, 70, 1),
                        ('BS6026', 'Thống kê', 3, 1, 4, 70, 1),
                        ('IT6035', 'Toán rời rạc', 3, 1, 4, 70, 1),
                        ('IT6070', 'An ninh mạng', 3, 1, 5, 70, 1),
                        ('IT6002', 'Cấu trúc dữ liệu và giải thuật', 3, 1, 5, 70, 1),
                        ('IT6065', 'Hệ thống cơ sở dữ liệu', 3, 1, 5, 70, 1),
                        ('IT6015', 'Kỹ thuật lập trình', 3, 1, 6, 70, 1),
                        ('IT6018', 'Lập trình hướng đối tượng', 3, 1, 6, 70, 1),
                        ('IT6019', 'Lập trình Java', 3, 1, 7, 70, 1),
                        ('IT6084', 'Kiểm thử phần mềm', 3, 1, 8, 70, 1),
                        ('IT6067', 'Kiến trúc máy tính và hệ điều hành', 3, 1, 8, 70, 1),
                        ('IT6082', 'Nhập môn công nghệ phần mềm', 3, 1, 9, 70, 1),
                        ('IT6094', 'Trí tuệ nhân tạo', 3, 1, 9, 70, 1),
                        ('IT6073', 'Ngôn ngữ lập trình khoa học', 3, 1, 9, 70, 0),
                        ('IT6053', 'Đồ án chuyên ngành', 3, 1, 10, 70, 0);
